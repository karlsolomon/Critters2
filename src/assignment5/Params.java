...
public class Params {
	public static Double world_width = 50.0;//needs to be int
	public static Double world_height = 50.0;//needs to be int
	public static double canvas_width = 800;//delete
	public static double canvas_height = 600;//delete
	...
	public static int bin_size;//delete
	public static int photosynthesis_energy_amount = 1;
	public static int start_energy = 100;
	public static int look_energy_cost = 1;
	public static int animation_speed = 1;//delete
    static double leftMargin = 180;//delete
    static double rightMargin = 10;//delete
    static double bottomMargin = 25;//delete
    static double topMargin = 35;//delete
